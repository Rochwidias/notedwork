...
/** Logo Google "G" multicolor resmi — warna fix, tidak ikut currentColor. */
export function IconGoogle(p: IconProps) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} aria-hidden="true">
      ...
      <path fill="#EA4335" d="M12 4.7c1.8 0 3 .8 3.7 1.4l3.3-3.2C17.9 1.1 15.2 0 12 0 7.4 0 3.4 2.5 1.4 6.7l3.8 2.9c.9-2.8 3.6-4.9 6.8-4.9z" />
    </svg>
  );
}
